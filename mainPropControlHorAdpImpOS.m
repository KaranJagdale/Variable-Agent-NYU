s_val = 0; e_val = 10;
parsep = 0.5;
totSim = (e_val - s_val)/parsep;
simOResHor1 = zeros(totSim);
hor = 1;
for fPas1 = s_val:parsep:e_val
    for fPas2 = s_val:parsep:e_val
        rng(3)    
        ...
        jP1 = 1; jP2 = 1;
        %fPas1 = 0.55; fPas2 = 0.5; %reward function parameters
        almu = 2/n_s;
        ...
        disp(fPas2/parsep +1)
        simOResHor1(round((fPas1-s_val)/parsep + 1), round((fPas2-s_val)/parsep+1)) = (w_wait*avg_wait1 + avg_inveh + w_walk*avg_walk1)/60;
